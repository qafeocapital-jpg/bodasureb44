      ...
      <div className="flex gap-2 border-b border-border mb-6 overflow-x-auto">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 font-semibold text-sm border-b-2 -mb-[1px] whitespace-nowrap ${
            activeTab === 'bulk' ? 'text-[#ff5a1f] border-[#ff5a1f]' : 'text-muted-foreground border-transparent'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 font-semibold text-sm border-b-2 -mb-[1px] whitespace-nowrap ${
            activeTab === 'logs' ? 'text-[#ff5a1f] border-[#ff5a1f]' : 'text-muted-foreground border-transparent'
          }`}
        >
